...
const distPath = path.resolve(__dirname, 'PowerNI.ie/PowerNI/wwwroot/dist');

console.log('\n📦 Reorganizing PowerNI component files...');
...
<head>
  ...
  <title>${component.charAt(0).toUpperCase() + component.slice(1)} Component - PowerNI</title>
  <link rel="stylesheet" href="./${component}.min.css">
</head>
<body class="brand-powerni">
  <div class="container my-5">
    <h1>${component.charAt(0).toUpperCase() + component.slice(1)} Component</h1>
    <p>PowerNI component template for ${component}</p>
  </div>${scriptTag}
</body>
</html>`;
...
console.log('✨ PowerNI reorganization complete!\n');
